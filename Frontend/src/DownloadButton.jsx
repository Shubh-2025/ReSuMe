const Button = ({ name, onClick, disabled }) => {
  return (
    ...
    >
      ...
      <p role="button" className={`group relative inline-flex items-center justify-center text-base rounded-xl bg-gray-900 px-8 py-3 font-semibold text-white transition-all duration-200 ${!disabled && 'hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30'}`}>
        {name}
