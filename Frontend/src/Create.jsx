                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-slate-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-slate-600 mb-6">
                            <div className="flex items-center justify-center space-x-2">
                                <div className="w-6 h-6 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-xs font-semibold">1</div>
                                <span>Choose Template</span>
                            </div>
                            <div className="flex items-center justify-center space-x-2">
                                <div className="w-6 h-6 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-xs font-semibold">2</div>
                                <span>Customize Content</span>
                            </div>
                            <div className="flex items-center justify-center space-x-2">
                                <div className="w-6 h-6 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-xs font-semibold">3</div>
                                <span>Download PDF</span>
                            </div>
                        </div>
                        <p className="text-slate-500 text-sm">
                            All templates are fully customizable and optimized for Applicant Tracking Systems
                        </p>
                    </div>
                </motion.div>
            </main>
